//
//  TaksiMapViewRepresentable.swift
//  Taksi
//
...
struct TaksiMapViewRepresentable: UIViewRepresentable  {
...
extension TaksiMapViewRepresentable {
    class MapCoordinator: NSObject,MKMapViewDelegate {
        //MARK: -  Properties
        let parent: TaksiMapViewRepresentable
        var userLocationCoordinate: CLLocationCoordinate2D?
        var currentRegion: MKCoordinateRegion?
        
        //MARK: -  Lifecycle
        init(parent: TaksiMapViewRepresentable) {
            self.parent = parent
            super.init()
        }
